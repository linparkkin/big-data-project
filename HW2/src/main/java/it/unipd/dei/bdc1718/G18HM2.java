  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    JavaPairRDD<String, Long> wordCountWC1 = docs
      .flatMapToPair((doc) -> {                                       // <-- Map phase
        ...
        each group of words is counted using the Collectors.counting method .
    ...
    JavaPairRDD<String, Long> wordCountWC2 = docs
      .flatMapToPair((String doc) -> {                                    // <-- Map phase
        ...
        */
        ...
        [0, sqrt(N)) and N is the overall number of words
         */
        for(Map.Entry<String, Long> entry: wordsCount.entrySet()) {
      ...
      .flatMapToPair((pair) -> {
         ...
         */
        Map<String, Long> wordsCount = streamPairs.collect(Collectors.groupingBy((x) -> x._1(), Collectors.summingLong(x -> x._2())));
     ...
     *******************************************/
      ...
      System.out.println("\n********* TIME PERFORMANCES ********");
      System.out.println("Elapsed time with straightforward algorithm: " + (endWCS - startWCS) + " ms");
      System.out.println("Elapsed time with improved word count 1 algorithm: " + (endWC1 - startWC1) + " ms");
      System.out.println("Elapsed time with improved word count 2 algorithm: " + (endWC2 - startWC2) + " ms");
      System.out.println("Elapsed time with improved word count 1 with reduceByKey method: " + (endWCR - startWCR) + " ms");
